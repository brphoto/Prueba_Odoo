...
pagos o WhatsApp a un único módulo.''',
    ...
    'data': [
        ...
        'data/chatroom_ai_playbook_data.xml',
        'data/ir_cron_data.xml',
        'data/chatroom_ai_dashboard_data.xml',
        'data/chatroom_ai_quick_action_agent_data.xml',
        ...
        'views/chatroom_ai_automation_run_views.xml',
        'views/chatroom_ai_playbook_views.xml',
    ...
    'assets': {
        ...
        'web.assets_tests': [
            'chatroom_ai_agent/static/tests/tours/chatroom_ai_agent_panel_tour.js',
        ],
    },
    'installable': True,
    'application': False,
