...
def _ensure_colombian_rules(env, parameter, structures):
    ...
    definitions = [
        ...
        (18, "Salud a cargo del empleador", "SALUD_EMPRESA", "employer_contribution", "add", "rule('IBC_BASE') > 0 and not legal('employer_health_exempt')", "rule('IBC_BASE') * legal('health_employer_rate') / 100.0", "Aporte patronal; la exoneración se activa solo con soporte legal de la compañía."),
        ...
        (22, "SENA", "SENA", "employer_contribution", "add", "rule('IBC_BASE') > 0 and not legal('employer_sena_exempt')", "rule('IBC_BASE') * legal('sena_rate') / 100.0", "Aporte parafiscal sujeto a las condiciones legales de exoneración."),
        (23, "ICBF", "ICBF", "employer_contribution", "add", "rule('IBC_BASE') > 0 and not legal('employer_icbf_exempt')", "rule('IBC_BASE') * legal('icbf_rate') / 100.0", "Aporte parafiscal sujeto a las condiciones legales de exoneración."),
