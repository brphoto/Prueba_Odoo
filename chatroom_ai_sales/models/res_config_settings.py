...
class ResConfigSettings(models.TransientModel):
    ...
    chatroom_ai_sales_validate_stock = fields.Boolean(
        ...
        help='Bloquea la confirmación automática si la existencia disponible no cubre el carrito.',
    )
    chatroom_ai_sales_validate_price = fields.Boolean(
        ...
        help='Solicita revisión si el precio del carrito ya no coincide con el precio vigente.',
    )
